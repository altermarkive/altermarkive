...
```bash
docker run --rm -it -v $PWD:/w -w /w --entrypoint jhead altermarkive/exif ...
docker run --rm -it -v $PWD:/w -w /w --entrypoint exiftime altermarkive/exif ...
docker run --rm -it -v $PWD:/w -w /w --entrypoint exiftool altermarkive/exif ...
```
