...
apt-get -yq install apt-transport-https ca-certificates gnupg-agent software-properties-common curl zip poppler-utils libgxps-utils python3 python3-pip python3-dev python3-tk build-essential git libfreetype6-dev libpng-dev jq gettext nmap netcat-openbsd tcpdump
