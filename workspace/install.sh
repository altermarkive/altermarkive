...
apt-get -yq install apt-transport-https ca-certificates gnupg-agent software-properties-common curl zip python3 python3-pip python3-dev python3-tk build-essential libfreetype6-dev libpng-dev gettext nmap netcat-openbsd tcpdump
