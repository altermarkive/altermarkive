...
```bash
podman run -it --rm --pull=always --name ollama --device nvidia.com/gpu=all --network host --userns=keep-id -v $HOME/.ollama:/root/.ollama:U ollama/ollama
```
